...
const Footer = () => {
    ...
    const SocialIcon = ({ children, ariaLabel }: { children: React.ReactNode; ariaLabel: string }) => (
        <button
            className="w-[60px] h-[60px] md:w-[76px] md:h-[76px] lg:w-[92px] lg:h-[92px] bg-white bg-opacity-20 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-opacity-30 hover:scale-105"
    ...
    return (
        <footer className="w-full bg-[#213c44] py-8 md:py-12 lg:py-16 xl:py-20 px-4 md:px-8 lg:px-12 xl:px-20 text-white">
            <div className="w-full">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-6 md:gap-8 lg:gap-0 mb-10 md:mb-12 lg:mb-16">
                    {/* Brand Section */}
                    <div className="mb-6 lg:mb-0">
                        <h2
                            className="font-bold text-white leading-tight mb-4 md:mb-6 text-2xl md:text-4xl lg:text-5xl xl:text-[64px]"
                            style={{ fontFamily: 'Lato, sans-serif' }}
                        >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 w-full lg:w-auto">
                        ...
                        <div className="flex gap-3 md:gap-4">
                            <SocialIcon ariaLabel="Follow us on Facebook">
                                <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="text-white md:w-10 md:h-10 lg:w-[42px] lg:h-[42px]">
                        ...
                        <div className="w-full sm:w-auto">
                            <AnimatedButton
                                ...
                                width="w-[200px] md:w-[250px] lg:w-[297px]"
                                height="h-[60px] md:h-[76px] lg:h-[92px]"
                                textSize="text-[32px] md:text-[40px] lg:text-[48px]"
